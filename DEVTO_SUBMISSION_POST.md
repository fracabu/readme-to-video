...
cover_video: https://stream.mux.com/jiVxoqG4Vzh8Ptewa01KStZhrIj2wLtknDTb02rEBrBy00.m3u8
---
...
{% embed https://stream.mux.com/jiVxoqG4Vzh8Ptewa01KStZhrIj2wLtknDTb02rEBrBy00.m3u8 %}
...
**Try it yourself**: Just paste any public GitHub repo URL and watch the magic happen!
...
- **Durations**: 30s (2 scenes) or 60s (4 scenes)
- **Real-time Progress**: SSE updates showing each generation step
- **One-click Sharing**: Download, copy link, or embed

### Cost Efficiency

| Service | Cost |
|---------|------|
| LLM (OpenRouter free tier) | $0.00 |
| Video Generation (Sora 2) | ~$0.15 per 10-15s clip |
| Mux Streaming | Pay-as-you-go |

**Total cost per video: ~$0.30-0.60** - accessible to every indie developer.
...
**Built with Next.js, Sora 2 AI, and Mux**
